public class Music extends AbstractItem{
     ...
     */
    public Music(String name, String genre, String year, String damaged, String onLoan, String sorting){
        this.name = name;
        this.genre = genre;
        this.year = year;
    ...
    public String getSortString() {
        String fullString = "Music" + this.name + this.year + this.genre;
        return fullString;
    }
    ...
    public String toString(){
        return this.name + ";" + this.genre + ";" + this.year + ";" + 
                "Music" + ";" + this.damaged + ";" + this.onLoan;
    }
