public class Movie extends AbstractItem{
     ...
     */
    public Movie(String name, String genre, String year, String damaged, String onLoan, String sorting){
        this.name = name;
        this.genre = genre;
        this.year = year;
    ...
    public String getSortString() {
        String fullString = "Movie" + this.name + this.year + this.genre;
        return fullString;
    }
    ...
    public String toString(){
        return this.name + ";" + this.genre + ";" + this.year + ";" + 
                "Movie" + ";" + this.damaged + ";" + this.onLoan;
    }
